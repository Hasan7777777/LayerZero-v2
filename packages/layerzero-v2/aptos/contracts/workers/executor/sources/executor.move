module executor::executor {
    ...
    use executor::native_drop_params::{Self, NativeDropParams, unpack_native_drop_params};
    ...
    public entry fun native_drop(
        ...
        let params = native_drop_params::deserialize_native_drop_params(&serialized_params);
        let total_amount = native_drop_params::calculate_total_amount(params);
    ...
    /// Sets the multiplier preminum for the executor
