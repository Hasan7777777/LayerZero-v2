module msglib_types::worker_options {
    ...
    const EINVALID_OPTION_LENGTH: u64 = 1;
    const EINVALID_DVN_IDX: u64 = 2;
    const EINVALID_OPTION_TYPE: u64 = 3;
    const EINVALID_WORKER_ID: u64 = 4;
    const EINVALID_LEGACY_OPTIONS_TYPE_1: u64 = 5;
    const EINVALID_LEGACY_OPTIONS_TYPE_2: u64 = 6;
}