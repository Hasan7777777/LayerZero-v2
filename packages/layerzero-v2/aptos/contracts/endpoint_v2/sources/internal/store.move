module endpoint_v2::store {
    ...
    public(friend) fun is_oapp_registered(oapp: address): bool acquires EndpointStore {
    ...
    public(friend) fun receive_pathway_registered(
        ...
        if (is_oapp_registered(receiver) && has_channel(receiver, src_eid, sender)) {
    ...
    public(friend) fun is_composer_registered(composer: address): bool acquires EndpointStore {
