...
module endpoint_v2_common::universal_config_tests {
    ...
    use endpoint_v2_common::universal_config::{
        ...
        is_zro_metadata, lock_zro_address, set_zro_address,
    };
    use endpoint_v2_common::zro_test_helpers::create_fa;

    #[test]
    fun test_eid() {
        let ep_common = &create_signer_for_test(@endpoint_v2_common);
    ...
    fun test_eid_should_fail_if_not_endpoint_v2_common() {
